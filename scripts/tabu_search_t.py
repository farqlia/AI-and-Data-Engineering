...
if __name__ == "__main__":
    ...
    for test_case in test_cases:
        ...
        new_sol, found_solutions = tabu_search(g, OptimizationType.TIME, *test_case)
        solutions.append(new_sol)
        with open(TABU_SEARCH_DIR_TIME / (stop_name(test_case[0]) + '.json'), mode='w', encoding='utf-8') as f:
            json.dump({"solution": new_sol, "found_solutions": found_solutions}, f, indent=4)

    with open(TABU_SEARCH_DIR_TIME / 'summary.json', mode='w', encoding='utf-8') as f:
